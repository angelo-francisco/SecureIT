...
class Configuration(models.Model):
    ...
    fps = models.PositiveIntegerField(default=15, validators=[MinValueValidator(1)], verbose_name="FPS")  # type: ignore
    monitoring_start_time = models.TimeField(null=True, blank=True, verbose_name="Início do Monitoramento")
