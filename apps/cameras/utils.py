...
def create_camera(user, location, connection_type):
    ...
    camera = Camera.objects.create(
        user=user, location=location, connection_type=connection_type
    )
...
def create_wifi_camera(camera_id, stream_url, username, password):
    ...
    return WifiCamera.objects.create(
        camera=camera_id,
...
def create_local_camera(camera_id, camera_path, cameras_list):
    ...
    return LocalCamera.objects.create(camera_id=camera_id, info=camera_info)
