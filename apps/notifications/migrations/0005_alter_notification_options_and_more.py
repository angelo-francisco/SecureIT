...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='notification',
            name='level',
            field=models.CharField(choices=[('I', 'Informação'), ('E', 'Erro'), ('S', 'Suspeito'), ('P', 'Perigo')], max_length=1, verbose_name='Nível'),
        ),
        migrations.AlterField(
            model_name='notification',
            name='readed',
        ...
        migrations.AlterField(
            model_name='notification',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to=settings.AUTH_USER_MODEL, verbose_name='Utilizador'),
        ),
        migrations.AddIndex(
            model_name='notification',
            index=models.Index(fields=['user', 'readed', 'deleted'], name='notificatio_user_id_248330_idx'),
        ),
        migrations.AddIndex(
            model_name='notification',
