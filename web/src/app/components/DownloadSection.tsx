...
const platforms = [
	{
		...
		icon: (
			<svg
				...
				viewBox="0 0 256 256"
			>
				<title xmlns="">microsoft-windows-icon</title>
				<path
					fill="#0078d4"
		...
		icon: (
			...
			>
				...
				<g fill="none">
					...
					/>
					<path
						fill="url(#SVGZrQemdEu)"
						d="M147.245 25.02c-.459 12.581-14.325 23.51-30.946 24.52S86.639 41 87.097 28.419c.46-12.581 14.326-23.509 30.947-24.519c16.62-.918 29.66 8.54 29.201 21.12"
						transform="translate(10)"
					/>
					<path
						fill="url(#SVGViD9UWNq)"
						d="M107.483 54.957c.46 8.173-3.397 15.06-8.723 15.335s-10.01-6.06-10.469-14.233s3.398-15.06 8.724-15.335s10.01 6.06 10.468 14.233"
						transform="translate(10)"
					/>
					<path
						fill="url(#SVGpwAGebry)"
