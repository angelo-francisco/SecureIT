...
export const NotificationsSection = forwardRef<NotificationsSectionHandle, NotificationsSectionProps>(
  ({ data: initialData }, ref) => {
    const [response, setResponse] = useState<NotificationsResponse | null>(initialData);
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <p className={`text-sm font-medium ${n.read ? "text-text-muted" : "text-text"}`}>
                        {n.title}
                      </p>
                      {!n.read && (
                    ...
                    <p className={`text-sm mt-0.5 ${n.read ? "text-text-muted" : "text-text/70"}`}>
                      {n.message}
                    </p>
