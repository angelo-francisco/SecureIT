...
def main():
    ...
    print()
    print("Add to your web server env:")
    print(f"  ED25519_PRIVATE_KEY_PATH={private_path}")
    print()
    print("Add to your desktop API env:")
    print(f"  ED25519_PUBLIC_KEY_PATH={public_path}")
    print()
    print("For Docker, copy the PEM files into the container or mount them.")
    print()
