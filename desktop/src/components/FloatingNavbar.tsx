...
export function FloatingNavbar({ activeView, onSelect }: FloatingNavbarProps) {
  return (
    ...
    >
      <div className="flex items-center gap-1.5 px-2 py-2 bg-[#0B0E14]/85 backdrop-blur-2xl backdrop-saturate-150 border border-white/[0.08] shadow-[0_8px_32px_-8px_rgba(0,0,0,0.6)]">
        {menuItems.map((item) => {
