...
export interface OutlinedInputProps extends InputHTMLAttributes<HTMLInputElement> {
  label: string;
  id: string;
  error?: boolean;
}
  ...
  return (
    <div className="relative">
      <input
        id={id}
        className={cn(
          "peer w-full h-14 px-4 pt-2.5 pb-1.5 bg-transparent text-text text-lg caret-primary",
